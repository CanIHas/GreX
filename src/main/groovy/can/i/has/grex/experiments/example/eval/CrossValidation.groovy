package can.i.has.grex.experiments.example.eval

import can.i.has.grex.experiments.example.model.ClassificationAlgorithm
import can.i.has.grex.experiments.example.model.Classifier
import can.i.has.grex.experiments.example.model.DataSet
import can.i.has.grex.experiments.example.model.Instance
